...
| `--model-out String`    | String  | `gomoku_cnn.pt`                 | Specifies the name of model checkpoint will be saved. The checkpoint with the highest validation Top-1 accuracy is retained.                               |
